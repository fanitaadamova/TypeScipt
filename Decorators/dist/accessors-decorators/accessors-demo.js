...
let Person = (() => {
    ...
    return class Person {
        static {
            ...
            __esDecorate(this, null, _project_decorators, { kind: "accessor", name: "project", static: false, private: false, access: { has: obj => "project" in obj, get: obj => obj.project, set: (obj, value) => { obj.project = value; } } }, _project_initializers, _instanceExtraInitializers);
        }
...
function watchChanges(accessor, context) {
    return {
        ...
        set: function (value) {
            ...
            console.log(`The property "${context.name.toString()}" class has been set to "${value}"`);
