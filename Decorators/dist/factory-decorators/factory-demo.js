...
let Employee1 = (() => {
    ...
    return class Employee1 {
        static {
            _tasks_decorators = [withTaskAdd({ nameOfTask: "Task - 1", levelOfTask: "hard" })];
            _extraTasks_decorators = [withComplicatedTaskAdd()];
...
// Decorator's scope
function withTaskAdd(inputTask) {
    // Filed's scp[e]
