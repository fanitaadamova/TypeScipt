...
let Salary = (() => {
    ...
    let _getSalaryTotal_decorators;
    return class Salary {
        static {
            _getSalaryTotal_decorators = [withExtraMoney(20)];
            __esDecorate(this, null, _getSalaryTotal_decorators, { kind: "method", name: "getSalaryTotal", static: false, private: false, access: { has: obj => "getSalaryTotal" in obj, get: obj => obj.getSalaryTotal } }, null, _instanceExtraInitializers);
        }
