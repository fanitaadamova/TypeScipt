...
function withEmployementDatePrototype(value: Function, context: ClassDecoratorContext) {
...
function withEmployementDate<T extends Args>(
    ...
    return class extends baseClass {
        ...
        constructor(...args: any[]) {
            ...
            console.log(
                `2. Added employementDate property to the ${baseClass.name} class!`
            );
        }
    };
}
...
function printData(value: Function, context: ClassDecoratorContext) {
    ...
    context.addInitializer(() => {
      console.log(`1. Class with name ${context.name} has been initialized!`);
    });
  }